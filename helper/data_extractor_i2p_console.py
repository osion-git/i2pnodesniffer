...
def get_ports():
    print("Starte den Abruf der Ports über 'kubectl'...")
...
def main():
    print("Starte die Router-Info Extraktion (lokal über NodePort)...")
    ports = get_ports()
    if not ports:
        print("Keine Ports gefunden. Überprüfen Sie den Dienst.")
        return
    for port in ports:
    ...
    print("Alle Routerinformationen wurden erfolgreich extrahiert und gespeichert!")
